...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText passwordText = (EditText) findViewById(R.id.passwardText);
        final EditText emailText = (EditText) findViewById(R.id.emailText);

        Button regusterButton = (Button)findViewById(R.id.registerButton);
        ...
        validateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                validateRequest validateRequst = new validateRequest(userID, responseListener);
                RequestQueue queue = Volley.newRequestQueue(RegisterActivity.this);
                queue.add(validateRequst);
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RegistRequest registRequest = new RegistRequest(userID, userPassword, userGender, userEmail, responseListener);
                RequestQueue queue = Volley.newRequestQueue(RegisterActivity.this);
