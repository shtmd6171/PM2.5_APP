...
public class Select_Adapter extends RecyclerView.Adapter<Select_Adapter.ItemViewHolder> {
    ...
    public Select_Adapter(Context mContext) {
    ...
    @Override
    public Select_Adapter.ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //ListView에 보여줄 View를 만들어주는 부분이다.
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list, parent, false);
        return new Select_Adapter.ItemViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final Select_Adapter.ItemViewHolder holder, int position) {
